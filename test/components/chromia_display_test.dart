...
void main() {
  ...
  group('ChromiaChip', () {
    ...
    testWidgets('filter chip renders selected state without crash', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(
  ...
  group('ChromiaAvatarGroup', () {
    ...
    testWidgets('shows overflow indicator when avatars exceed max', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(
  ...
  group('ChromiaListTile', () {
    ...
    testWidgets('renders with leading and trailing without crash', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildTestApp(
