...
import 'package:chromia_ui_example/presentation/screens/inputs_screen.dart';
...
final routes = <ExampleRoute>[
  ...
  ExampleRoute(title: 'Inputs', icon: Icons.dynamic_form_rounded, path: '/inputs', child: const InputsScreen()),
